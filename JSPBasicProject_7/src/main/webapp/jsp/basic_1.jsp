	 ...
	 3. 내장 객체 => 미리 생성후에 사용이 가능하게한다
	 	...
	 	동작
	 	  => 1. JSP소스 생성 => 실행
	 	  	 ...
	 	  	 4.jsp
	 	  	 	1) => _jspServoce() => 사용자 요청시마다 호출되는 메소드
	 	  	 		  {
	 	  	 		  	============
	 	  	 		  	여기서 첨부되는 소스 코딩
	 	  	 		  	============
	 	  ...
	 	  => 주요 메소드
	 	  	 requset
	 	  	   ...
	 	  	   = getParameter() ; 단일값을 받는 경우
	 	  	      ...
	 	  	      => getParameterValues() => 다중 (checkbox)
	 	  	         **웹은 모든 데이터 String
	 	  	         	=> 변환 => Wrapper
	 	  	      => 사용자 요청 =============> 서버(웹서버 => 톰캣(WSA)) =======> 개발자
	 	  	      ...
	 	  	      http://localhost/JSPBasicProject_7/jsp/a.jsp?name=%ED%99%8D%EA%B8%B8%EB%8F%99
 						...
 						============================= MVC
 						= getRequestURI , getRequestURL , getContext
 						= getRemoterAddr()
 			response     
 				= addCookie()
 				= sendRedirect()

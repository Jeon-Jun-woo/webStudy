...
<%--
	    ...
	    1) 연산자
	       ...
	       =======================================================
	       ${requestScope.name} => request.getAttribute("name") 키값
	       				  =====키
	    ...
	    => class Sawon
	       ...
	       request.getAttribute("vo",vo) => 해당 JSP로 요청값 전송

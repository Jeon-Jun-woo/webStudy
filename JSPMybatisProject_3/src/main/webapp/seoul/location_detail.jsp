            ...
            <tr style="display:none" id="u${rvo.no }" class="ups">
	         <td>
	          <form method="post" action="../reply/update.do">
		          ...
		          <input type="submit" value="댓글수정" style="float: left;width: 100px;height:98px;text-align: center;margin-left: 2px"
		            class="btn-primary"
		          >
	          </form>
	         </td>
	       ...
	       <tr>
	         <td>
	          <form method="post" action="../reply/insert.do">
		          ...
		          <input type="submit" value="댓글쓰기" style="float: left;width: 100px;height:98px;text-align: center;margin-left: 2px"
		            class="btn-primary"
		          >
	          </form>
	         </td>

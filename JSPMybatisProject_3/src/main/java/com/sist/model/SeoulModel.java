...
public class SeoulModel {
	 ...
	 *     B b;
	 *     public A(@ => 매개변수 B b) => 호출 매개변수 값을 설정
	 *     {	PARAMETER
	 *     }
	...
	public String location_datail(HttpServletRequest request,
			HttpServletResponse response)
	{
	...
	public String nature_datail(HttpServletRequest request,
			HttpServletResponse response)
	{
		String no=request.getParameter("no");

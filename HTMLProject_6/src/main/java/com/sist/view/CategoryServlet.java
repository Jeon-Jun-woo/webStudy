 ...
 *              | doPost
 *          | doGet => default (화면 UI) 
 *  4) destroy() : 사용자가 사이트를 이동 => 메모리 해제
 *  ======================================================
 *   => JSP
 *      _jspInit() => _jspService() => _jspDestroy()
 *                 ==============
 *                | 조건으로 POST/GET
 *   => JSP의 코딩 -> 메소드 영역이다 ==> servlet으로 변경
 */
...
public class CategoryServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         // 브라우저로 전송 => HTML로 보낼지 / xml로 보낼지 / json으로 보낼지
         ...
         out.write("<a href=CategoryServlet?cno=3 class=\"btn btn-sm btn-primary\">메뉴별 인기 맛집 리스트</a>");
         out.write("</div>");
         out.write("<div class=row>");
         /*
          *<div class="col-md-4">
         ...
         for(CategoryVO vo:list)
         {
            ...
            out.write("<img src="+vo.getPoster()+" alt=\"Lights\" style=\"width:100%\">"); // "/w3images/lights.jpg" => 이미지 넣는 칸
